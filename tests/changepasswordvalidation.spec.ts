...
test.describe('Change Password Validations', () => {
    ...
    test('TC-CP-01: Change Password heading is correct @smoke @sanity @regression', async () => {
    ...
    test('TC-CP-02: "Choose a new password" text is correct @regression', async () => {
    ...
    test('TC-CP-03: Withdrawal-restriction notice is correct @regression', async () => {
    ...
    test('TC-CP-04: Relogin-required notice is correct @regression', async () => {
    ...
    test('TC-CP-05: Old Password field label shows the required asterisk @regression', async () => {
    ...
    test('TC-CP-06: New Password field label shows the required asterisk @regression', async () => {
    ...
    test('TC-CP-07: Confirm Password field label shows the required asterisk @regression', async () => {
    ...
    test('TC-CP-08: Enter email OTP field label shows the required asterisk @regression', async () => {
    ...
    test('TC-CP-09: Old Password field placeholder is correct @regression', async () => {
    ...
    test('TC-CP-10: Old Password field eye-icon mask/reveal cycle @regression', async () => {
    ...
    test('TC-CP-11: New Password field placeholder is correct @regression', async () => {
    ...
    test('TC-CP-12: New Password field eye-icon mask/reveal cycle @regression', async () => {
        const value = 'Test@123';
    ...
    test('TC-CP-13: Confirm Password field placeholder is correct @regression', async () => {
    ...
    test('TC-CP-14: Confirm Password field eye-icon mask/reveal cycle @regression', async () => {
        const value = 'Test@123';
    ...
    test('TC-CP-15: "Get OTP" button text is correct @regression', async () => {
    ...
    test('TC-CP-16: Old Password required validation @regression', async () => {
    ...
    test('TC-CP-17: New Password required validation @regression', async () => {
    ...
    test('TC-CP-18: Confirm Password required validation @regression', async () => {
    ...
    test('TC-CP-19: OTP required validation @regression', async () => {
    ...
    // ─── TC-CP-20 ────────────────────────────────────────────────────────────────
    test('TC-CP-20: New Password criteria validation @regression', async () => {
    ...
    // ─── TC-CP-21 ────────────────────────────────────────────────────────────────
    test('TC-CP-21: Confirm Password mismatch validation @regression', async () => {
    ...
    test('TC-CP-22: OTP not requested error validation @regression', async () => {
    ...
    test('TC-CP-23: OTP sent successfully, then a ~60s cooldown before Get OTP is clickable again @regression', async () => {
    ...
    // ─── TC-CP-24 ────────────────────────────────────────────────────────────────
    test('TC-CP-24: Incorrect OTP validation @regression', async () => {
    ...
    // ─── TC-CP-25 ────────────────────────────────────────────────────────────────
    test('TC-CP-25: Old Password incorrect validation @regression', async () => {
    ...
    // seen before.
    test.skip('TC-CP-26: OTP already used validation @regression', async () => {
    ...
    // ─── TC-CP-27 ────────────────────────────────────────────────────────────────
    test('TC-CP-27: OTP resent successfully validation @regression', async () => {
    ...
    // ─── TC-CP-28 ────────────────────────────────────────────────────────────────
    test('TC-CP-28: New Password same as Old validation @regression', async () => {
    ...
    // ─── TC-CP-29 ────────────────────────────────────────────────────────────────
    test('TC-CP-29: OTP length exceeded validation @regression', async () => {
    ...
    // ─── TC-CP-30 ────────────────────────────────────────────────────────────────
    test('TC-CP-30: Close Change Password modal @regression', async () => {
