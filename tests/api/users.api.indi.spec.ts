...
test('POST - create a user', async ({ apiHelper }: { apiHelper: any }) => {
...
test('PUT - update a user', async ({ apiHelper }: { apiHelper: any }) => {
    //create a user: POST
    let userResponse = await createUser(apiHelper);
    let userUpdatedData = {
...
test('DELETE - delete a user', async ({ apiHelper }: { apiHelper: any }) => {
    //create a user: POST
    let userResponse = await createUser(apiHelper);
