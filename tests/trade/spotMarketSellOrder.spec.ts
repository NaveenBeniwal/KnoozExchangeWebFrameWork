...
test.describe.serial('Spot Module — Market Sell Order Positive Flow', () => {
    ...
    // ── TC-06a ────────────────────────────────────────────────────────────────
    test('TC-06a: Market Sell tab Price field is visible but disabled', async () => {
    ...
    // ── TC-06a1 ───────────────────────────────────────────────────────────────
    test('TC-06a1: Sell button label shows "SELL {baseCoin}"', async () => {
    ...
    // ── TC-06a2 ───────────────────────────────────────────────────────────────
    test('TC-06a2: base coin (BTC) sell available balance is non-negative', async () => {
    ...
    test('TC-06a3: 25% button fills correct amount', async () => {
    ...
    test('TC-06a4: 50% button fills correct amount', async () => {
        const avlb   = await spotMarketSellPage.getSellAvailableBalance();
    ...
    test('TC-06a5: 75% button fills correct amount', async () => {
        const avlb   = await spotMarketSellPage.getSellAvailableBalance();
    ...
    test('TC-06a6: 100% button fills correct amount', async () => {
        const avlb   = await spotMarketSellPage.getSellAvailableBalance();
    ...
    // ── TC-06b ────────────────────────────────────────────────────────────────
    test('TC-06b: capture full balance snapshot before placing market sell order', async () => {
    ...
    // ── TC-07 ─────────────────────────────────────────────────────────────────
    test('TC-07: enter market sell amount (base coin), verify estimated fee', async () => {
    ...
    // ── TC-08 ─────────────────────────────────────────────────────────────────
    test('TC-08: base coin (BTC) available balance before market sell noted', async () => {
