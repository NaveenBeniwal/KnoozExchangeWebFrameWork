...
test.describe.serial('Spot Module — Market Buy Order Positive Flow', () => {
    ...
    // ── TC-06a ────────────────────────────────────────────────────────────────
    test('TC-06a: Market Buy tab Price field is visible but disabled @sanity', async () => {
    ...
    // ── TC-06a1 ───────────────────────────────────────────────────────────────
    test('TC-06a1: Buy button label shows "BUY {baseCoin}" @sanity', async () => {
    ...
    // ── TC-06a2 ───────────────────────────────────────────────────────────────
    test('TC-06a2: quote currency (USDT) available balance is non-negative @sanity', async () => {
    ...
    test('TC-06a3: 25% button fills correct spend amount @sanity', async () => {
    ...
    test('TC-06a4: 50% button fills correct spend amount @sanity', async () => {
        const avlb   = await spotMarketBuyPage.getBuyAvailableBalance();
    ...
    test('TC-06a5: 75% button fills correct spend amount @sanity', async () => {
        const avlb   = await spotMarketBuyPage.getBuyAvailableBalance();
    ...
    test('TC-06a6: 100% button fills correct spend amount @sanity', async () => {
        const avlb   = await spotMarketBuyPage.getBuyAvailableBalance();
    ...
    // ── TC-06b ────────────────────────────────────────────────────────────────
    test('TC-06b: capture full balance snapshot before placing market buy order @sanity', async () => {
    ...
    // ── TC-07 ─────────────────────────────────────────────────────────────────
    test('TC-07: enter market buy order amount (total to spend), verify fee @sanity', async () => {
    ...
    // ── TC-08 ─────────────────────────────────────────────────────────────────
    test('TC-08: USDT available balance before market buy noted @sanity', async () => {
