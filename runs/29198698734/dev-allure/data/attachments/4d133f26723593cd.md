...
- Name: trade/spottraderoundtrip.spec.ts >> Spot Module — Buy/Sell Round-Trip Smoke & Sanity Flow >> TC-RT-01: navigate to Spot Trading page @smoke @sanity @regression
- Location: tests/trade/spottraderoundtrip.spec.ts:69:5
...
Call log:
  - waiting for getByText('Home', { exact: true }) to be visible
