...
- Name: portfolio/spot.spec.ts >> Hide Zero Balance hides zero-total coins and toggle works correctly across 3 cycles @regression
- Location: tests/portfolio/spot.spec.ts:226:1
