...
- Name: portfolio/coinDetail.spec.ts >> Portfolio Module — Coin Detail Page >> coin detail page shows coin name, Overview tab and Primary balance tab @smoke @sanity
